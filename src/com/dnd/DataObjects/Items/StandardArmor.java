...
public class StandardArmor {
    ...
    public static final Armor natural = new Armor("Natural", "Not wearing any armor (ac 10 + dex mod)", null, 0, 10, 100, "none", 0, 0, 0, 0, Rarities.common);
    ...
    public static final Armor leather = new Armor("Leather", "(ac 11 + dex mod) light armor", null, 0, 11, 100, "The Breastplate and shoulder protectors of this armor are made of leather that has been stiffened by being boiled in oil. The rest of the armor is made of softer and more flexible materials", 0, 10, 0, 0, Rarities.common);
    public static final Armor studdedLeather = new Armor("Studded Leather", "(ac 12 + dex mod) light armor", null, 0, 12, 100, "Made from tough but flexible leather, studded leather is reinforced with close-set rivets or spikes.", 0, 45, 0, 0, Rarities.common);

    public static final Armor hide = new Armor("Hide", "(ac 12 + 2 dex mod max) medium armor", null, 0, 12, 2, "thick furs and pelts", 0, 10, 0, 0, Rarities.common);
    public static final Armor breastplate = new Armor("Breastplate", "(ac 14 + 2 dex mod max) medium armor", null, 0, 14, 2, "a fitted metal chest piece worn with supple leather", 0, 400, 0, 0, Rarities.common);
    public static final Armor chainShirt = new Armor("Chain Shirt", "(ac 13 + 2 dex mod max) medium armor", null, 0, 13, 2, "interlocking metal rings, a chain shirt is worn between layers of clothing or leather", 0, 50, 0, 0, Rarities.common);
