...
public class Races {
    ...
    public List<Race> generateRaceData() {
        ...
        List<Race> raceData = new ArrayList<Race>((Arrays.asList(
            ...
            new Race(human, Sizes.medium, 30, 0, 15, 15, 15, 15, 15, 5, 5, 5, 10, 10, 10, 0, 0, 0, 0, 0, 0, new ArrayList<>(Arrays.asList("", "")), new ArrayList<>(Arrays.asList(Languages.common,"other")),18,90,0, 8),
