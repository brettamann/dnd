...
public class Races {
    ...
    public List<Race> generateRaceData() {
        ...
        List<Race> raceData = new ArrayList<Race>((Arrays.asList(
            ...
            new Race(genasi, Sizes.medium, 30, 0, 15, 15, 5, 5, 5, 5, 5, 5, 23, 24, 23, 0, 0, 2, 0, 0, 0, new ArrayList<>(Arrays.asList(null)), new ArrayList<>(Arrays.asList(Languages.common, Languages.primordial)),18,120,0, 3), //Genasi can be air, earth, fire, or water, and their type determines their abilities. These are added in on person creation.
            new Race(gith, Sizes.medium, 30, 0, 15, 15, 39, 2, 2, 39, 2, 2, 10, 2, 2, 0, 0, 0, 0, 0, 0, new ArrayList<>(Arrays.asList(null)), new ArrayList<>(Arrays.asList(Languages.common, "other")),18,100,0, 5), //gith get a bonus, figured out in Person class, based on their alignment
            ...
            new Race(goliath, Sizes.medium, 30, 0, 15, 15, 15, 15, 15, 3, 9, 3, 10, 15, 15, 2, 0, 1, 0, 0, 0, new ArrayList<>(Arrays.asList("Once per rest as a reaction may roll a d12+CONMOD and reduce damage taken by that amount","+4 athletics")), new ArrayList<>(Arrays.asList(Languages.common, Languages.giant)),18,90,7, 3),
            ...
            new Race(human, Sizes.medium, 30, 0, 15, 15, 15, 15, 15, 5, 5, 5, 10, 10, 10, 0, 0, 0, 0, 0, 0, new ArrayList<>(Arrays.asList(null)), new ArrayList<>(Arrays.asList(Languages.common,"other")),18,90,0, 8),
