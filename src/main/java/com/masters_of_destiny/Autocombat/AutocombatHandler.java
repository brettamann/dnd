package com.masters_of_destiny.Autocombat;
...
import com.masters_of_destiny.DataObjects.Items.StandardWeapons;
...
public class AutocombatHandler {
    ...
    public static EncounterObject epicCombat(PartyInfo partyInfo, List<PartyMember> originalPartyMembers, List<Person> originalOpponents, Location location){
        ...
        //for simplicity for now, we are just going to go players then opponents for attack order, in the same order. Can
