...
public class StandardLoot {
    ...
    //Each loot tier can include at least the tier below it as well

    //something that could be done to possibly make this more lightweight is make key/value pairs in a list in an object
    //then it might not be needed to have so many null or 0 attributes to account for every single thing
